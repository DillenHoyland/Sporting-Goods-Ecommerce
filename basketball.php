...
<html lang="en">
  ...
  <body>
    ...
    <div class="grid-container-2">
      ...
      <h2 class="checkout-title"><i>Basketball</i></h2>
      ...
      <div class="product">
        ...
        <div class="product-1">
          ...
          /> 
        <p><i><strong>£39.99</strong></i></p>
       <br></br>
        <p><i>Perfect in its shapliness, The polymer orb is sublime to the touch. </i></p>
        <br></br>
        <ul>
            <li>Perfect symmetry</li>
            <li>Extreme bounce potential</li>
            <li>Feather-lite</li>
            <li>Desert Storm skin</li>
        </ul>
        </div>
        <br></br>
        ...
        <button class="button-1 real-add" data-product-id="5" type="button">Add to Cart</button>
