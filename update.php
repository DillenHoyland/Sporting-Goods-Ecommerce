...
if (isset($_POST['update_product'])) {
    ...
    if (empty($product_name) || empty($product_price) || empty($product_id)) {
        ...
        $prepared->bind_param("sdi", $product_name, $product_price, $product_id);

        if ($prepared->execute()) {
            header("refresh:2;url=admin.php"); 
        } else {
            $invalid = "Database error: " . $conn->error;
        }
        $prepared->close();
    }
}
  ...
  <body>
    ...
    <div class="grid-container-2">
      ...
      <div class="grid-cell-3-p2" style="grid-area: box-3">
        ...
        <button><i><a href="register.php">Register</a></i></button>
      ...
      <h2 class="checkout-title"><i>Update Product</i></h2>

      <form action="update.php" method="POST" class="checkout">
