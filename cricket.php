...
<html lang="en">
  ...
  <body>
    ...
    <div class="grid-container-2">
      ...
      <h2 class="checkout-title"><i>Cricket Bat</i></h2>
      ...
      <div class="product">
       ...
       <br></br>
        <p><i>The curvature of the bat is balanced such, that the user gains strength </i></p>
        <br></br>
        <ul>
            <li>Mahogany-aged</li>
            <li>Multi-coloured handle</li>
            <li>Weighty thing</li>
            <li>Very powerful</li>
        </ul>
        </div>
        ...
        <div class="product-2">
        <button class="button-1 real-add" data-product-id="4" type="button">Add to Cart</button>
