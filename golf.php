  ...
  <body>
    ...
    <div class="grid-container-2">
      ...
      <div class="grid-cell-3-p2" style="grid-area: box-3">
        ...
        <button><i><a href="cart.php">Cart</i></a></button>
      ...
      <h2 class="checkout-title"><i>Golf Club</i></h2>
      ...
      <div class="product">
        ...
        <div class="product-1">
          ...
          /> 
        <p><i><strong>£59.99</strong></i></p>
       <br></br>
        <p><i>This club is derived from the remaining pieces of an ancient hammer. A fabulous and powerful club.</i></p>
        <br></br>
        <ul>
            <li>Incredibly light</li>
            <li>Huge power generation</li>
            <li>Sleek pleasing design</li>
            <li>Arctic frost grip</li>
        </ul>
        </div>
        <br></br>
        ...
        <div class="product-2">
       <button class="button-1 real-add" data-product-id="2" type="button">Add to Cart</button>
